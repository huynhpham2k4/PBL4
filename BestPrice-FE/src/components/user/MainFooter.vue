<template>
  <footer
    class="text-center text-lg-start bg-body-tertiary text-muted bg-body-secondary mt-0"
  >
        ...
        <div class="row mt-3" bis_skin_checked="1">
          ...
          >
            ...
            <h6 class="text-uppercase fw-bold mb-4">
              <i class="fas fa-gem me-3"></i>BestPrice
            </h6>
            <p>
          ...
          >
            <!-- Links -->
            <h6 class="text-uppercase fw-bold mb-4">Sản phẩn</h6>
            <p>
    ...
    <div
      ...
      bis_skin_checked="1"
    >
      © 2013 - 2023 Bản quyền thuộc về Công ty cổ phần BestPrice Việt Nam
    </div>
    <!-- Copyright -->
  </footer>
</template>
